  ...
  return (
    <div>
      ...
      <div className="recommended-flex">
        ...
        <button className="btns" value="zSunflowers" onClick={handleRecommendedBtns}>Sunflowers</button>
        <button className="btns" value="Daisy" onClick={handleRecommendedBtns}>Tulip</button>
